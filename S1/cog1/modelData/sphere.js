...
define(["exports", "data", "glMatrix"], function(exports, data) {
	...
	exports.create = function(parameter) {
		...
		// Projeziert einen Ortsvektor auf den Einheitskreis
		...
		// Durchgänge für die Durchläufe
		for (var $d = 1; $d <= details; $d++) {

			// Anzahl der Polygone
			var polyCount = instance.polygonVertices.length;

			// Alle Dreiecke (Polygone) durchlaufen und vierteln
			for (var p = 0; p < polyCount; p++) {

				// Mittelpunkte der Vektoren ermitteln (neue Punkte)
			...
			// Löschen der vorherigen Polygone
